...
function bata_product_bundle_admin_page() {
    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td><input type="text" name="bata_product_bundles[bundle_name]" value="" required /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Product IDs (comma separated)</th>
                    <td><input type="text" name="bata_product_bundles[product_ids]" value="" placeholder="e.g., 1,2,3" required /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Bundle Price</th>
                    <td><input type="number" step="0.01" name="bata_product_bundles[bundle_price]" value="" required /></td>
                </tr>
            </table>
        ...
        if (!empty($bundles)) {
            ...
            echo '<thead><tr><th>ID</th><th>Bundle Name</th><th>Product IDs</th><th>Bundle Price</th></tr></thead>';
            echo '<tbody>';
            // Since this is a simple example, we are showing only one bundle
            // In a real-world plugin, this would be a loop
            echo '<tr>';
            echo '<td>1</td>';
            ...
            echo '</tbody>';
            echo '</table>';
            echo '<p>Use the shortcode: <code>[bata_product_bundle bundle_id="1"]</code></p>';
        } else {
...
add_action('wp_ajax_nopriv_bata_add_to_cart_bundle', 'bata_add_bundle_to_cart_ajax');